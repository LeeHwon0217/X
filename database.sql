...
insert into users (userid, password, name, email, url) values ('apple', '1111', '김사과', 'apple@apple.com', 'naver.com');

select * from users where idx=2;

insert into posts (useridx, text) values (7, '안녕하세요!');
DELETE FROM users WHERE idx = '{"text":"바뀐 글 저장하기!!"}';
